...
import org.example.precrime.domain.prearrest.PreArrestStatus
import org.example.precrime.infrastructure.integration.persistence.jooq.tables.references.PRE_ARREST
...
class JooqPreArrestRepository(
    ...
    @Transactional(propagation = Propagation.MANDATORY)
    override fun update(preArrest: PreArrest) {
